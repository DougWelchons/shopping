...
class MarketTest < Minitest::Test
  ...
  def test_it_can_return_overstoked_items
    market = Market.new("South Pearl Street Farmers Market")
    vendor1 = Vendor.new("Rocky Mountain Fresh")
    vendor2 = Vendor.new("Ba-Nom-a-Nom")
    vendor3 = Vendor.new("Palisade Peach Shack")
  ...
  def test_it_can_return_the_markets_date
    Date.stubs(:today).returns(Time.mktime(2021, 1, 4))
    market = Market.new("South Pearl Street Farmers Market")

    assert_equal '04/01/2021', market.date
  end
  ...
  #   market.add_vendor(vendor3)
  #
  #   assert_equal false, market.sell_item(item1, 100_000)
  #   assert_equal true, market.sell_item(item1, 45)
